...
Behavior:
  ...
  - Copies produced RPMs from ABLS-AGENT-SHELLY/build to ABLS-PKGS/public/rpms/<arch>
  - Copies produced DEBs from ABLS-AGENT-SHELLY/build/deb/<suite>/<arch> to ABLS-PKGS/deb-packages/<suite>/
...
copy_built_packages_to_abls_pkgs_repo() {
  ...
  for rpm_file in "${rpm_files[@]}"; do
    ...
    run_cmd "cp -f '$rpm_file' '$target_dir/'"
  done
